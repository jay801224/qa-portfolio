...
class test_19gamespin(unittest.TestCase):
    ...
    def test1900(self):
        ...
        assert newcurrenturl == get_slotgameurl('1900'), "当前遊戲网址非预期！"
        ...
        self.driver.save_screenshot('./result/'+get_day()+'\\'+get_time()+'1900-spin.png')
        time.sleep(3)
        #打開投注記錄頁面
        self.driver.execute_script("window.open()")
        ...
        for i in range(60):
            try:
                ...
                self.fail("time out")
        try: 
            self.assertEqual("Garudaman", driver.find_element_by_xpath("//table[@id='__BVID__11']/tbody/tr/td[3]").text)
        except AssertionError as e: 
            self.verificationErrors.append(str(e))
    ...
    def test1901(self):
        ...
        urltoken = tokenpara.split('&betrecordurl')[0]
        print("跳轉網址前半段是：", newcurrenturl)
        assert newcurrenturl == get_slotgameurl('1901'), "当前遊戲网址非预期！"
        pic_path = './result/'+get_day()+'\\'
        ...
        # work on firefox
        #ActionChains(driver).move_by_offset(-1075, -900).perform() # 将鼠标位置恢复到移动前 
        self.driver.save_screenshot('./result/'+get_day()+'\\'+get_time()+'1901-spin.png')
        time.sleep(3)
        #打開投注記錄頁面
        self.driver.execute_script("window.open()")
        self.driver.switch_to.window(driver.window_handles[2])
        ...
        for i in range(60):
            try:
                ...
                self.fail("time out")
        try: 
            self.assertEqual("Konser Dangdut", driver.find_element_by_xpath("//table[@id='__BVID__11']/tbody/tr/td[3]").text)
        except AssertionError as e: 
            self.verificationErrors.append(str(e))
    ...
    def test1902(self):
        ...
        urltoken = tokenpara.split('&betrecordurl')[0]
        print("跳轉網址前半段是：", newcurrenturl)
        assert newcurrenturl == get_slotgameurl('1902'), "当前遊戲网址非预期！"
        pic_path = './result/'+get_day()+'\\'
        ...
        # 新UI spin按鈕坐標
        time.sleep(5)
        self.driver.save_screenshot('./result/'+get_day()+'\\'+get_time()+'1902-spin.png')
        time.sleep(3)
        #打開投注記錄頁面
        self.driver.execute_script("window.open()")
        self.driver.switch_to.window(driver.window_handles[2])
        ...
        for i in range(60):
            try:
                ...
                self.fail("time out")
        try: 
            self.assertEqual("Pendekar Kapak", driver.find_element_by_xpath("//table[@id='__BVID__11']/tbody/tr/td[3]").text)
        except AssertionError as e: 
            self.verificationErrors.append(str(e))
    ...
    def test1903(self):
        ...
        urltoken = tokenpara.split('&betrecordurl')[0]
        print("跳轉網址前半段是：", newcurrenturl)
        assert newcurrenturl == get_slotgameurl('1903'), "当前遊戲网址非预期！"
        pic_path = './result/'+get_day()+'\\'
        ...
        # work on firefox
        #ActionChains(driver).move_by_offset(-1075, -900).perform() # 将鼠标位置恢复到移动前 
        self.driver.save_screenshot('./result/'+get_day()+'\\'+get_time()+'1903-spin.png')
        time.sleep(3)
        #打開投注記錄頁面
        self.driver.execute_script("window.open()")
        self.driver.switch_to.window(driver.window_handles[2])
        ...
        for i in range(60):
            try:
                ...
                self.fail("time out")
        try: 
            self.assertEqual("Poskamling", driver.find_element_by_xpath("//table[@id='__BVID__11']/tbody/tr/td[3]").text)
        except AssertionError as e: 
            self.verificationErrors.append(str(e))
    ...
    def test1904(self):
        ...
        urltoken = tokenpara.split('&betrecordurl')[0]
        print("跳轉網址前半段是：", newcurrenturl)
        assert newcurrenturl == get_slotgameurl('1904'), "当前遊戲网址非预期！"
        pic_path = './result/'+get_day()+'\\'
        ...
        # work on firefox
        #ActionChains(driver).move_by_offset(-1075, -900).perform() # 将鼠标位置恢复到移动前 
        self.driver.save_screenshot('./result/'+get_day()+'\\'+get_time()+'1904-spin.png')
        time.sleep(3)
        #打開投注記錄頁面
        self.driver.execute_script("window.open()")
        self.driver.switch_to.window(driver.window_handles[2])
        ...
        for i in range(60):
            try:
                ...
                self.fail("time out")
        try: 
            self.assertEqual("Sejarah Kemerdekaan", driver.find_element_by_xpath("//table[@id='__BVID__11']/tbody/tr/td[3]").text)
        except AssertionError as e: 
            self.verificationErrors.append(str(e))
    ...
    def test1905(self):
        ...
        urltoken = tokenpara.split('&betrecordurl')[0]
        print("跳轉網址前半段是：", newcurrenturl)
        assert newcurrenturl == get_slotgameurl('1905'), "当前遊戲网址非预期！"
        pic_path = './result/'+get_day()+'\\'
        ...
        # work on firefox
        #ActionChains(driver).move_by_offset(-1075, -900).perform() # 将鼠标位置恢复到移动前 
        self.driver.save_screenshot('./result/'+get_day()+'\\'+get_time()+'1905-spin.png')
        time.sleep(3)
        #打開投注記錄頁面
        self.driver.execute_script("window.open()")
        self.driver.switch_to.window(driver.window_handles[2])
        ...
        for i in range(60):
            try:
                ...
                self.fail("time out")
        try: 
            self.assertEqual("Bartender", driver.find_element_by_xpath("//table[@id='__BVID__11']/tbody/tr/td[3]").text)
        except AssertionError as e: 
            self.verificationErrors.append(str(e))
    ...
    def test1906(self):
        ...
        urltoken = tokenpara.split('&betrecordurl')[0]
        print("跳轉網址前半段是：", newcurrenturl)
        assert newcurrenturl == get_slotgameurl('1906'), "当前遊戲网址非预期！"
        pic_path = './result/'+get_day()+'\\'
        ...
        # work on firefox
        #ActionChains(driver).move_by_offset(-1075, -900).perform() # 将鼠标位置恢复到移动前 
        self.driver.save_screenshot('./result/'+get_day()+'\\'+get_time()+'1906-spin.png')
        time.sleep(3)
        #打開投注記錄頁面
        self.driver.execute_script("window.open()")
        self.driver.switch_to.window(driver.window_handles[2])
        ...
        for i in range(60):
            try:
                ...
                self.fail("time out")
        try: 
            self.assertEqual("Lutung Kasarung & Putri Purbasari", driver.find_element_by_xpath("//table[@id='__BVID__11']/tbody/tr/td[3]").text)
        except AssertionError as e: 
            self.verificationErrors.append(str(e))
    ...
    def test1907(self):
        ...
        urltoken = tokenpara.split('&betrecordurl')[0]
        print("跳轉網址前半段是：", newcurrenturl)
        assert newcurrenturl == get_slotgameurl('1907'), "当前遊戲网址非预期！"
        pic_path = './result/'+get_day()+'\\'
        ...
        # work on firefox
        #ActionChains(driver).move_by_offset(-1075, -900).perform() # 将鼠标位置恢复到移动前 
        self.driver.save_screenshot('./result/'+get_day()+'\\'+get_time()+'1907-spin.png')
        time.sleep(3)
        #打開投注記錄頁面
        self.driver.execute_script("window.open()")
        self.driver.switch_to.window(driver.window_handles[2])
        ...
        for i in range(60):
            try:
                ...
                self.fail("time out")
        try: 
            self.assertEqual("PNS Cantik", driver.find_element_by_xpath("//table[@id='__BVID__11']/tbody/tr/td[3]").text)
        except AssertionError as e: 
            self.verificationErrors.append(str(e))
    ...
    def test1908(self):
        ...
        urltoken = tokenpara.split('&betrecordurl')[0]
        print("跳轉網址前半段是：", newcurrenturl)
        assert newcurrenturl == get_slotgameurl('1908'), "当前遊戲网址非预期！"
        pic_path = './result/'+get_day()+'\\'
        ...
        # work on firefox
        #ActionChains(driver).move_by_offset(-1075, -900).perform() # 将鼠标位置恢复到移动前 
        self.driver.save_screenshot('./result/'+get_day()+'\\'+get_time()+'1908-spin.png')
        time.sleep(3)
        #打開投注記錄頁面
        self.driver.execute_script("window.open()")
        self.driver.switch_to.window(driver.window_handles[2])
        ...
        for i in range(60):
            try:
                ...
                self.fail("time out")
        try: 
            self.assertEqual("Keindahan Raja Ampat", driver.find_element_by_xpath("//table[@id='__BVID__11']/tbody/tr/td[3]").text)
        except AssertionError as e: 
            self.verificationErrors.append(str(e))
...
if __name__ == "__main__":
    ...
    unittest.addTest(test_19gamespin("test1900")) 
    unittest.addTest(test_19gamespin("test1901"))
    unittest.addTest(test_19gamespin("test1902"))
    unittest.addTest(test_19gamespin("test1903"))
    unittest.addTest(test_19gamespin("test1904"))
    unittest.addTest(test_19gamespin("test1905"))
    unittest.addTest(test_19gamespin("test1906"))
    unittest.addTest(test_19gamespin("test1907"))
    unittest.addTest(test_19gamespin("test1908"))

    #将测试结果写入到result.html中
    fp=open(get_time()+"-19 result.html",'wb')
    runner=HTMLTestRunner(stream=fp,title='19 Test Report',description='Result:',tester='jay')
    runner.run(unittest)
    fp.close()