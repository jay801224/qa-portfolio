...
class test_newgamespin(unittest.TestCase):
    ...
    def test2201(self):
        ...
        urltoken = tokenpara.split('&betrecordurl')[0]
        print("跳轉網址前半段是：", newcurrenturl)
        assert newcurrenturl == get_22slotgameurl('2201'), "当前遊戲网址非预期！"
        pic_path = './result/'+get_day()+'\\'
        ...
        # work on firefox
        #ActionChains(driver).move_by_offset(-1075, -900).perform() # 将鼠标位置恢复到移动前 
        self.driver.save_screenshot('./result/'+get_day()+'\\'+get_time()+'2201-spin.png')
        time.sleep(3)
        #打開投注記錄頁面
        self.driver.execute_script("window.open()")
        self.driver.switch_to.window(driver.window_handles[2])
        ...
        for i in range(60):
            try:
                ...
                self.fail("time out")
        try: 
            self.assertEqual("Taman Fantasi", driver.find_element_by_xpath("//table[@id='__BVID__11']/tbody/tr/td[3]").text)
        except AssertionError as e: 
            self.verificationErrors.append(str(e))
    ...
    def test2202(self):
        ...
        urltoken = tokenpara.split('&betrecordurl')[0]
        print("跳轉網址前半段是：", newcurrenturl)
        assert newcurrenturl == get_22slotgameurl('2202'), "当前遊戲网址非预期！"
        pic_path = './result/'+get_day()+'\\'
        ...
        # work on firefox
        #ActionChains(driver).move_by_offset(-1075, -900).perform() # 将鼠标位置恢复到移动前 
        self.driver.save_screenshot('./result/'+get_day()+'\\'+get_time()+'2202-spin.png')
        time.sleep(3)
        #打開投注記錄頁面
        self.driver.execute_script("window.open()")
        self.driver.switch_to.window(driver.window_handles[2])
        ...
        for i in range(60):
            try:
                ...
                self.fail("time out")
        try: 
            self.assertEqual("Pasar Malam", driver.find_element_by_xpath("//table[@id='__BVID__11']/tbody/tr/td[3]").text)
        except AssertionError as e: 
            self.verificationErrors.append(str(e))
    ...
    def test2203(self):
        ...
        urltoken = tokenpara.split('&betrecordurl')[0]
        print("跳轉網址前半段是：", newcurrenturl)
        assert newcurrenturl == get_22slotgameurl('2203'), "当前遊戲网址非预期！"
        pic_path = './result/'+get_day()+'\\'
        ...
        # work on firefox
        #ActionChains(driver).move_by_offset(-1075, -900).perform() # 将鼠标位置恢复到移动前 
        self.driver.save_screenshot('./result/'+get_day()+'\\'+get_time()+'2203-spin.png')
        time.sleep(3)
        #打開投注記錄頁面
        self.driver.execute_script("window.open()")
        self.driver.switch_to.window(driver.window_handles[2])
        ...
        for i in range(60):
            try:
                ...
                self.fail("time out")
        try: 
            self.assertEqual("Pendekar Buta", driver.find_element_by_xpath("//table[@id='__BVID__11']/tbody/tr/td[3]").text)
        except AssertionError as e: 
            self.verificationErrors.append(str(e))
    ...
    def test2302(self):
        ...
        urltoken = tokenpara.split('&betrecordurl')[0]
        print("跳轉網址前半段是：", newcurrenturl)
        assert newcurrenturl == get_23slotgameurl('2302'), "当前遊戲网址非预期！"
        pic_path = './result/'+get_day()+'\\'
        ...
        # work on firefox
        #ActionChains(driver).move_by_offset(-1075, -900).perform() # 将鼠标位置恢复到移动前 
        self.driver.save_screenshot('./result/'+get_day()+'\\'+get_time()+'2302-spin.png')
        time.sleep(3)
        #打開投注記錄頁面
        self.driver.execute_script("window.open()")
        self.driver.switch_to.window(driver.window_handles[2])
        ...
        for i in range(60):
            try:
                ...
                self.fail("time out")
        try: 
            self.assertEqual("Nusantara Berkarya", driver.find_element_by_xpath("//table[@id='__BVID__11']/tbody/tr/td[3]").text)
        except AssertionError as e: 
            self.verificationErrors.append(str(e))
    ...
    def test2401(self):
        ...
        urltoken = tokenpara.split('&betrecordurl')[0]
        print("跳轉網址前半段是：", newcurrenturl)
        assert newcurrenturl == get_24slotgameurl('2401'), "当前遊戲网址非预期！"
        pic_path = './result/'+get_day()+'\\'
        ...
        # work on firefox
        #ActionChains(driver).move_by_offset(-1075, -900).perform() # 将鼠标位置恢复到移动前 
        self.driver.save_screenshot('./result/'+get_day()+'\\'+get_time()+'2401-spin.png')
        time.sleep(3)
        #打開投注記錄頁面
        self.driver.execute_script("window.open()")
        self.driver.switch_to.window(driver.window_handles[2])
        ...
        for i in range(60):
            try:
                ...
                self.fail("time out")
        try: 
            self.assertEqual("Karawitan", driver.find_element_by_xpath("//table[@id='__BVID__11']/tbody/tr/td[3]").text)
        except AssertionError as e: 
            self.verificationErrors.append(str(e))
    ...
    def test2501(self):
        ...
        urltoken = tokenpara.split('&betrecordurl')[0]
        print("跳轉網址前半段是：", newcurrenturl)
        assert newcurrenturl == get_25gridgameurl('2501'), "当前遊戲网址非预期！"
        pic_path = './result/'+get_day()+'\\'
        ...
        # work on firefox
        #ActionChains(driver).move_by_offset(-1075, -900).perform() # 将鼠标位置恢复到移动前 
        self.driver.save_screenshot('./result/'+get_day()+'\\'+get_time()+'2501-spin.png')
        time.sleep(3)
        #打開投注記錄頁面
        self.driver.execute_script("window.open()")
        self.driver.switch_to.window(driver.window_handles[2])
        ...
        for i in range(60):
            try:
                ...
                self.fail("time out")
        try: 
            self.assertEqual("Adat Nusantara", driver.find_element_by_xpath("//table[@id='__BVID__11']/tbody/tr/td[3]").text)
        except AssertionError as e: 
            self.verificationErrors.append(str(e))
...
if __name__ == "__main__":
    ...
    unittest.addTest(test_newgamespin("test2201"))
    unittest.addTest(test_newgamespin("test2202"))
    unittest.addTest(test_newgamespin("test2203"))
    unittest.addTest(test_newgamespin("test2300"))
    unittest.addTest(test_newgamespin("test2301"))
    unittest.addTest(test_newgamespin("test2302"))
    unittest.addTest(test_newgamespin("test2400"))
    unittest.addTest(test_newgamespin("test2401"))
    unittest.addTest(test_newgamespin("test2500"))
    unittest.addTest(test_newgamespin("test2501"))
